...
const uint8_t Font_3_TomThumb_ExtendedBitmaps[] = {
    0x00,                               /* 0x20 space */
...
#if (Font_3_TomThumb_Extended_USE_EXTENDED)
...
#endif                                  /* (Font_3_TomThumb_Extended_USE_EXTENDED)  */
};

/* {offset, width, height, advance cursor, x offset, y offset} */
const GFXglyph Font_3_TomThumb_ExtendedGlyphs[] = {
...
const GFXfont Font_3_TomThumb_Extended = {
    (uint8_t *)Font_3_TomThumb_ExtendedBitmaps,
    (GFXglyph *)Font_3_TomThumb_ExtendedGlyphs,
    0x20, 0x7E, 6};
